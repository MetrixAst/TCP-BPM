...
urlpatterns = [
    ...
    path('leaves/timeline-page/', views.leave_timeline_page, name='leave_timeline_page'),
    ...
    path('leaves/<int:pk>/confirm/', views.leave_confirm, name='leave_confirm'),
    ...
    path('attendance/registry/', views.attendance_registry, name='attendance_registry'),
    ...
    path('attendance/office-qr/', views.office_qr_admin, name='office_qr_admin'),
    path('attendance/office-qr/reissue/', views.office_qr_reissue, name='office_qr_reissue'),
    path('attendance/office-qr/label/', views.office_qr_label_pdf, name='office_qr_label_pdf'),
