...
class Tasks {
  ...
  constructor(options = {}) {
    ...
    Helpers.FetchJSON(Helpers.UrlFix('/static/site/json/tasks.json'), (data) => {
  ...
  _addListeners() {
    ...
    this.addNewButton && this.addNewButton.addEventListener('click', this._showNewTaskModal.bind(this));
  ...
  _showNewTaskModal(event) {
    ...
    document.getElementById('taskModalTitle').innerHTML = 'Новая задача';
  }
  ...
  _editTaskById(id) {
    ...
    document.getElementById('taskModalTitle').innerHTML = 'Редактирование задачи';
  }
