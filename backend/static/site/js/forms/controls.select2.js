...
class Select2Controls {
  ...
  _initCustomSelect() {
    $('.custom_select').each(function(){
      const placeholder = $(this).attr('placeholder') || '',
            search = ($(this).attr('data-search') || '0') == '1' ? true : false;
      

      jQuery(this).select2({
        minimumResultsForSearch: search ? null : Infinity,
  ...
  // No search field
  _initSearchHidden() {
    jQuery('#select2SearchHidden').select2({minimumResultsForSearch: Infinity, placeholder: 'Статус'});
  }
