...
class TagControls {
  constructor() {
    ...
    this._initUsersListTags('#usersListTags');
    this._initUsersListTags('#usersListTags2');
  ...
  _initUsersListTags(id) {
    if (document.querySelector(id)) {
      ...
      var tagifyUserList = new Tagify(document.querySelector(id), {
        enforceWhitelist: true,
        ...
        whitelist: [
          {
            value: 1,
            name: 'Алиханова Сания',
            avatar: '/static/site/img/profile/profile-1.webp',
            email: 'jhattersley0@ucsd.edu',
          },
          {
            value: 2,
            name: 'Николаев Игорь',
            avatar: '/static/site/img/profile/profile-2.webp',
            email: 'aesson1@ning.com',
          },
          {
            value: 3,
            name: 'Бараева Юлия',
            avatar: '/static/site/img/profile/profile-3.webp',
            email: 'abatisse2@nih.gov',
          },
          {
            value: 4,
            name: 'Астахова Мария',
            avatar: '/static/site/img/profile/profile-4.webp',
            email: 'gyellowley3@behance.net',
          },
          {
            value: 5,
            name: 'Савельев Павел',
            avatar: '/static/site/img/profile/profile-5.webp',
            email: 'dwilford4@jugem.jp',
          },
          {
            value: 6,
            name: 'Новикова Клара',
            avatar: '/static/site/img/profile/profile-6.webp',
            email: 'corwin5@meetup.com',
          },
          {
            value: 7,
            name: 'Батырханов Алижан',
            avatar: '/static/site/img/profile/profile-7.webp',
            email: 'smain6@techcrunch.com',
          },
          {
            value: 8,
            name: 'Базарбаева Алия',
            avatar: '/static/site/img/profile/profile-8.webp',
