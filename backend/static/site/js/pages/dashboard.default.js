...
class DashboardDefault {
  constructor() {
    ...
    this._initSalesStocksCharts('largeLineChart1', 'Продажи');
    this._initSalesStocksCharts('largeLineChart2', 'Посетители');
    this._initSalesStocksCharts('largeLineChart3', 'Средний чек');
    this._initSalesStocksCharts('largeLineChart4', 'Количество продаж');
    this._initSalesStocksCharts('largeLineChart5', 'Конверсия');
    this._initSalesStocksCharts('largeLineChart6', 'Коммунальные услуги');
  ...
  _initSalesStocksCharts(target, title) {
    if (document.getElementById(target)) {
      this._largeLineChart1 = ChartsExtend.LargeLineChart(target, {
