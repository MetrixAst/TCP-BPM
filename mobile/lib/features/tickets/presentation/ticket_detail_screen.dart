    ...
    setState(() {
      ...
      switch (messagesResult) {
        case Success(:final data):
          _messages = data;
        case Failure():
          break; // не блокируем экран, если только чат не загрузился
      }
    });
    ...
    return SafeArea(
      child: Container(
        ...
        decoration: const BoxDecoration(
          color: MetrixColors.surface,
          border: Border(top: BorderSide(color: MetrixColors.border)),
        ),
        child: Row(
          children: [
            Expanded(
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(statusLabel, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 13.5)),
